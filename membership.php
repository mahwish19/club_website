  ...
  <head>
    <meta charset="utf-8" />
    <title>CodeWizard - Club Membership</title>
              ...
              >
                <div class="navbar-nav mr-auto py-0">
                  ...
                  <div class="nav-item dropdown">
                    ...
                    >
                    <div class="dropdown-menu rounded-0 m-0">
                      <a href="membership.php" class="dropdown-item active"
                        >Club Membership</a
                      >
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Become a member of <span class="text-primary text-uppercase">CodeWizard</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="/codewizard/membership-registration.php" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6">
