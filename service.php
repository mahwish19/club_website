  ...
  <body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
              ...
              >
                <div class="navbar-nav mr-auto py-0">
                  ...
                  <a href="service.php" class="nav-item nav-link active">Blogs</a>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <a class="service-item rounded"
              href="https://dev.to/fredy/8-free-resources-tools-for-web-developers-and-designers-1k3p" target="_blank">
              <h5 class="mb-3">
      ...
      <div class="row g-4">
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <a class="service-item rounded"
            href="https://blackboxofpm.com/product-management-mental-models-for-everyone-31e7828cb50b" target="_blank">
            <h5 class="mb-3">
              Product Management Mental Models for Everyone
            </h5>
            <p class="text-body mb-0">
